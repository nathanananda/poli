...
$flag_claim_keluarga = $last_insert["flag_claim_keluarga"];
$data_id = $last_insert["id"];

$biodata_keluarga = query("SELECT * FROM hrms_tanggungan_karyawan_sample WHERE Id = '$flag_claim_keluarga'")[0];
        ...
        <div class="box w-100 px-md-5">
          ...
          <div class="m-0 p-0 mx-md-5">
            ...
            <h4 class="pt-4 mx-3 mx-md-4 px-md-3">Detail Pengajuan</h4>
              <form class="form-user row g-3 px-5 pt-3" action="" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="data_id" id="data_id" value="<?= $last_insert["id"]; ?>"> 
                <input type="hidden" name="nik" id="nik" value="<?= $last_insert["nik"]; ?>">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control text-muted" id="nik" value="<?= $last_insert["nik"]; ?>" disabled>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control text-muted" id="nama_lengkap" value="<?= $biodata_keluarga["nama_lengkap"]; ?>" disabled>
                </div>
                <div class="col-md-6">
                  <label for="status_hubungan" class="form-label">Status Hubungan</label>
                  <input type="text" class="form-control text-muted" id="status_hubungan" value="<?= $biodata_keluarga["status_hubungan"]; ?>" disabled>
                </div>
                <hr> <br>
                <div class="col-md-6">
          ...
          <div class="footer pt-3"> 
                ...
                <table class="table table-borderless">
                  ...
                  <tbody class="text-center border-0">
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="controller/delete-detail-form-pengajuan-keluarga.php" method="POST">
            ...
            <div class="d-flex justify-content-end py-3">
              <form action="controller/draft-detail-form-pengajuan-keluarga.php" method="POST">
                <input type="hidden" name="data_id" id="data_id" value="<?= $data_id; ?>">
                <input type="hidden" name="nik" id="nik" value="<?= $nik; ?>">
                <button class="btn btn-save px-3 mx-3">Draft</button>      
              </form>
              <form action="controller/ajukan-form-pengajuan-keluarga.php" method="POST">
